...
macro(deploykit_configure_bundling TARGET_NAME)
            ...
            while(new_dependencies_found)
                ...
                foreach(dep \${resolved_deps})
                    ...
                    if(idx EQUAL -1)
                        ...
                        get_filename_component(real_dep_name \"\${real_dep}\" NAME)
                        list(APPEND copied_libs \"\${dep_name}\")
                        if(NOT \"\${dep_name}\" STREQUAL \"\${real_dep_name}\")
                            list(APPEND copied_libs \"\${real_dep_name}\")
                        endif()
                        list(APPEND binaries_to_analyze \"\${bundle_prefix}/lib/\${real_dep_name}\")
                        set(new_dependencies_found TRUE)
                    endif()
                endforeach()
    ...
    if(NOT DEFINED DEPLOYKIT_PRODUCT_DISPLAY_VERSION)
        set(DEPLOYKIT_PRODUCT_DISPLAY_VERSION "${CPACK_PACKAGE_VERSION}")
    endif()
