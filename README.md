...
- The main IFW component refreshes the global `ProductVersion` and updates the matching Windows uninstall `DisplayVersion` during MaintenanceTool updates so Apps & Features stays aligned with the installed application version.
