...
- The main IFW component refreshes the global `ProductVersion` when its script is loaded so MaintenanceTool updates keep the Windows Apps & Features `DisplayVersion` aligned with the installed application version.
